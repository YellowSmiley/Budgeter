...
using Transaction;
using static Transaction.TransactionService;

namespace server
{
    public class TransactionServiceImpl : TransactionServiceBase
    {
        ...
        public override async Task<ReadTransactionResponse> ReadTransaction(ReadTransactionRequest request, ServerCallContext context)
        {
            ...
            return new ReadTransactionResponse() { Transaction = transaction };
        }
        ...
        public override async Task<UpdateTransactionResponse> UpdateTransaction(UpdateTransactionRequest request, ServerCallContext context)
        {
            ...
            return new UpdateTransactionResponse() { Transaction = transaction };
        }
